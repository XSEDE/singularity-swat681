...
debug32/lidinit.o: lidinit.f debug32/main.o
	${FC} ${ARCH32} ${FFLAG} ${DFLAG}  lidinit.f -o debug32/lidinit.o -I debug32

debug32/lids.o: lids.f debug32/main.o
	${FC} ${ARCH32} ${FFLAG} ${DFLAG}  lids.f -o debug32/lids.o -I debug32

debug32/lid_cistern.o: lid_cistern.f debug32/main.o
	${FC} ${ARCH32} ${FFLAG} ${DFLAG}  lid_cistern.f -o debug32/lid_cistern.o -I debug32

debug32/lid_greenroof.o: lid_greenroof.f debug32/main.o
	${FC} ${ARCH32} ${FFLAG} ${DFLAG}  lid_greenroof.f -o debug32/lid_greenroof.o -I debug32

debug32/lid_porpavement.o: lid_porpavement.f debug32/main.o
	${FC} ${ARCH32} ${FFLAG} ${DFLAG}  lid_porpavement.f -o debug32/lid_porpavement.o -I debug32

debug32/lid_raingarden.o: lid_raingarden.f debug32/main.o
	${FC} ${ARCH32} ${FFLAG} ${DFLAG}  lid_raingarden.f -o debug32/lid_raingarden.o -I debug32
...
debug32/ndenit.o: ndenit.f debug32/main.o
	${FC} ${ARCH32} ${FFLAG} ${DFLAG} ${LONGFREE} ndenit.f -o debug32/ndenit.o -I debug32
...
debug32/readbsn.o: readbsn.f debug32/main.o
	${FC} ${ARCH32} ${FFLAG} ${DFLAG} ${LONGFIX} readbsn.f -o debug32/readbsn.o -I debug32
...
#	${FC} ${OBJECTS_DEBUG64} ${ARCH64} -static -o ${NAMEDEBUG64} jecoulte changed below
${NAMEDEBUG64}: ${OBJECTS_DEBUG64}
	${FC} ${OBJECTS_DEBUG64} ${ARCH64} -o ${NAMEDEBUG64}
...
debug64/hqdav.o: HQDAV.f90 debug64/main.o
	${FC} ${ARCH64} ${FFLAG} ${DFLAG}  HQDAV.f90 -o debug64/hqdav.o -I debug64
...
debug64/lidinit.o: lidinit.f debug64/main.o
	${FC} ${ARCH64} ${FFLAG} ${DFLAG}  lidinit.f -o debug64/lidinit.o -I debug64

debug64/lids.o: lids.f debug64/main.o
	${FC} ${ARCH64} ${FFLAG} ${DFLAG}  lids.f -o debug64/lids.o -I debug64

debug64/lid_cistern.o: lid_cistern.f debug64/main.o
	${FC} ${ARCH64} ${FFLAG} ${DFLAG}  lid_cistern.f -o debug64/lid_cistern.o -I debug64

debug64/lid_greenroof.o: lid_greenroof.f debug64/main.o
	${FC} ${ARCH64} ${FFLAG} ${DFLAG}  lid_greenroof.f -o debug64/lid_greenroof.o -I debug64

debug64/lid_porpavement.o: lid_porpavement.f debug64/main.o
	${FC} ${ARCH64} ${FFLAG} ${DFLAG}  lid_porpavement.f -o debug64/lid_porpavement.o -I debug64

debug64/lid_raingarden.o: lid_raingarden.f debug64/main.o
	${FC} ${ARCH64} ${FFLAG} ${DFLAG}  lid_raingarden.f -o debug64/lid_raingarden.o -I debug64

debug64/log_normal.o: log_normal.f debug64/main.o
	${FC} ${ARCH64} ${FFLAG} ${DFLAG}  log_normal.f -o debug64/log_normal.o -I debug64
...
debug64/ndenit.o: ndenit.f debug64/main.o
	${FC} ${ARCH64} ${FFLAG} ${DFLAG} ${LONGFREE} ndenit.f -o debug64/ndenit.o -I debug64
...
debug64/readbsn.o: readbsn.f debug64/main.o
	${FC} ${ARCH64} ${FFLAG} ${DFLAG} ${LONGFIX} readbsn.f -o debug64/readbsn.o -I debug64
...
debug64/rthvsc.o: rthvsc.f90 debug64/main.o
	${FC} ${ARCH64} ${FFLAG} ${DFLAG} ${LONGFIX} rthvsc.f90 -o debug64/rthvsc.o -I debug64
...
rel32/lidinit.o: lidinit.f rel32/main.o
	${FC} ${ARCH32} ${FFLAG} ${RFLAG}  lidinit.f -o rel32/lidinit.o -I rel32

rel32/lids.o: lids.f rel32/main.o
	${FC} ${ARCH32} ${FFLAG} ${RFLAG}  lids.f -o rel32/lids.o -I rel32

rel32/lid_cistern.o: lid_cistern.f rel32/main.o
	${FC} ${ARCH32} ${FFLAG} ${RFLAG}  lid_cistern.f -o rel32/lid_cistern.o -I rel32

rel32/lid_greenroof.o: lid_greenroof.f rel32/main.o
	${FC} ${ARCH32} ${FFLAG} ${RFLAG}  lid_greenroof.f -o rel32/lid_greenroof.o -I rel32

rel32/lid_porpavement.o: lid_porpavement.f rel32/main.o
	${FC} ${ARCH32} ${FFLAG} ${RFLAG}  lid_porpavement.f -o rel32/lid_porpavement.o -I rel32

rel32/lid_raingarden.o: lid_raingarden.f rel32/main.o
	${FC} ${ARCH32} ${FFLAG} ${RFLAG}  lid_raingarden.f -o rel32/lid_raingarden.o -I rel32
...
rel32/ndenit.o: ndenit.f rel32/main.o
	${FC} ${ARCH32} ${FFLAG} ${RFLAG} ${LONGFREE} ndenit.f -o rel32/ndenit.o -I rel32
...
rel32/readbsn.o: readbsn.f rel32/main.o
	${FC} ${ARCH32} ${FFLAG} ${RFLAG} ${LONGFIX} readbsn.f -o rel32/readbsn.o -I rel32
...
rel64/ndenit.o: ndenit.f rel64/main.o
	${FC} ${ARCH64} ${FFLAG} ${RFLAG}  ${LONGFREE} ndenit.f -o rel64/ndenit.o -I rel64
